                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" maxlength="30" minlength="1" name="description" aria-describedby="">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="idcategorie" class="form-control">
                                        ...
                                        <option value="{{$categories->idcategorie}}">{{$categories->nomcategorie}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
